...
import com.zpc.picture.adapter.PictureAlbumDirectoryAdapter;
import com.zpc.picture.adapter.PictureImageGridAdapter;
import com.zpc.picture.config.PictureConfig;
import com.zpc.picture.config.PictureMimeType;
import com.zpc.picture.decoration.GridSpacingItemDecoration;
import com.zpc.picture.dialog.CustomDialog;
import com.zpc.picture.entity.EventEntity;
import com.zpc.picture.entity.LocalMedia;
import com.zpc.picture.entity.LocalMediaFolder;
import com.zpc.picture.model.LocalMediaLoader;
import com.zpc.picture.observable.ImagesObservable;
import com.zpc.picture.permissions.RxPermissions;
import com.zpc.picture.rxbus2.RxBus;
import com.zpc.picture.rxbus2.Subscribe;
import com.zpc.picture.rxbus2.ThreadMode;
import com.zpc.picture.tools.DateUtils;
import com.zpc.picture.tools.DoubleUtils;
import com.zpc.picture.tools.PictureFileUtils;
import com.zpc.picture.tools.ScreenUtils;
import com.zpc.picture.tools.StringUtils;
import com.zpc.picture.tools.ToastManage;
import com.zpc.picture.ucrop.UCrop;
import com.zpc.picture.ucrop.UCropMulti;
import com.zpc.picture.ucrop.model.CutInfo;
import com.zpc.picture.widget.FolderPopWindow;
import com.zpc.picture.widget.PhotoPopupWindow;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void isNumComplete(boolean numComplete) {
        ...
        if (!numComplete) {
            animation = AnimationUtils.loadAnimation(this, R.anim.picture_modal_in);
        }
        animation = numComplete ? null : AnimationUtils.loadAnimation(this, R.anim.picture_modal_in);
    }
