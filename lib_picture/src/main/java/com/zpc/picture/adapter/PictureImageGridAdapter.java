package com.zpc.picture.adapter;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PictureImageGridAdapter(Context context, PictureSelectionConfig config) {
        ...
        animation = OptAnimationLoader.loadAnimation(context, R.anim.picture_modal_in);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                Drawable drawable = ContextCompat.getDrawable(context, R.drawable.picture_video_icon);
                StringUtils.modifyTextViewDrawable(contentHolder.tv_duration, drawable, 0);
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                contentHolder.iv_picture.setImageResource(R.drawable.picture_audio_placeholder);
            } else {
                ...
                options.centerCrop();
                options.placeholder(R.drawable.picture_image_placeholder);
                Glide.with(context)
                        .asBitmap()
                        .load(path)
                        .apply(options)
